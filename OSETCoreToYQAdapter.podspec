Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    ...
                    DESC
  s.homepage     = "https://github.com/OSETSDK/OSETCoreToYQAdapter"
  ...
  # 源文件配置
  s.source       = {
    :git => 'https://github.com/OSETSDK/OSETCoreToYQAdapter.git',
    :tag => s.version.to_s
  }
  # 主框架文件
  # 检查 OSETCoreToYQAdapter.podspec 关键字段
  s.source_files = 'OSETCoreToYQAdapter/**/*.{h,m}'
  # 系统框架依赖
  ...
  s.dependency 'OSETCoreSDK','>=6.6.5.3'
